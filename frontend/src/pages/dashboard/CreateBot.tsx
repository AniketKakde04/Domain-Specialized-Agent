      ...
      >
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-2">System Prompt (Optional Persona & Guardrails)</label>
              <textarea
                value={systemPrompt}
                onChange={(e) => setSystemPrompt(e.target.value)}
                className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 h-24 resize-none"
                placeholder="e.g., You are a strict Agricultural Advisor. Only recommend chemicals listed in your knowledge base."
              />
            </div>
          </div>
